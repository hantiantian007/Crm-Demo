            ...
            <div class="grid grid-cols-6 gap-4">
              ...
              <div class="col-span-2">
                ...
                <select v-model="form.auditStatus" class="h-9 w-full rounded-md border border-gray-200 bg-white px-3 text-xs text-gray-700 outline-none focus:border-[#C19B5E] focus:ring-2 focus:ring-[#C19B5E]/10">
                  ...
                  <option value="cs_pending">客服待审核</option>
                  <option value="cs_approved">客服已通过</option>
                  <option value="fin_pending">财务待审核</option>
                  <option value="fin_approved">财务已通过</option>
              ...
              <table class="min-w-full text-xs">
                <thead class="bg-white text-gray-500">
                  <tr class="border-b border-gray-100">
                    <th class="text-left font-medium px-5 py-4 whitespace-nowrap w-10"></th>
                    <th class="text-left font-medium px-5 py-4 whitespace-nowrap">订单信息</th>
