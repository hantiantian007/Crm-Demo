              ...
              <table class="min-w-full text-xs">
                <thead class="bg-white text-gray-500">
                  <tr class="border-b border-gray-100">
                    ...
                    <th class="text-left font-medium px-5 py-4 whitespace-nowrap">金额($)</th>
                    <th class="text-left font-medium px-5 py-4 whitespace-nowrap">提现MT账号</th>
                    <th class="text-left font-medium px-5 py-4 whitespace-nowrap">交易编号</th>
